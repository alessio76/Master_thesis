...
class PoseDataset(data.Dataset):
    def __init__(self, mode, num_pt, add_noise, root, noise_trans, refine):
        ...
        if mode == 'train':
            ...
            self.path = os.path.join(self.root,'santal_juice_dataset','train')
        elif mode == 'test':
             #read train images path from test.json used for yolact 
            self.path = os.path.join(self.root,'santal_juice_dataset','val')
        ...
        while 1:
            ...
            input_file=open(os.path.join(self.root,f"{class_input}",f"{class_input}.xyz"))
        ...
        camera_json_ptr = open(os.path.join(configuration_base_path,"camera_intrsics.json"))
        ...
        for i,object in enumerate(meta['objects']):
            ...
            if object['class'] in self.objects_classes:
                ...
                if len(mask.nonzero()[0]) > self.minimum_num_pt:
                    ...
                    print(cloud[:,0].shape)
                    ax1 = fig1.add_subplot(projection='3d')
                    img_plt = ax1.scatter(cloud[:,1], cloud[:,0], cloud[:,2])
