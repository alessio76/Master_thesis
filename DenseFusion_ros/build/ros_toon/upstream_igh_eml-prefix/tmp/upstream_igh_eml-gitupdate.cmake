...
execute_process(
  COMMAND "/usr/bin/git" show-ref TOON_3.2
  WORKING_DIRECTORY "/home/workstation2/AlessioBenitoAlterani/Master-thesis/DenseFusion_ros/build/ros_toon/upstream_igh_eml-prefix/src/upstream_igh_eml"
...
if("${show_ref_output}" MATCHES "refs/remotes/TOON_3.2")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "TOON_3.2")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "TOON_3.2")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 TOON_3.2
  WORKING_DIRECTORY "/home/workstation2/AlessioBenitoAlterani/Master-thesis/DenseFusion_ros/build/ros_toon/upstream_igh_eml-prefix/src/upstream_igh_eml"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/edrosten/TooN.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/workstation2/AlessioBenitoAlterani/Master-thesis/DenseFusion_ros/build/ros_toon/upstream_igh_eml-prefix/src/upstream_igh_eml/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/workstation2/AlessioBenitoAlterani/Master-thesis/DenseFusion_ros/build/ros_toon/upstream_igh_eml-prefix/src/upstream_igh_eml/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
