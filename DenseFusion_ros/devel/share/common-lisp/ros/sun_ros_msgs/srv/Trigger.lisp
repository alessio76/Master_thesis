...
(cl:in-package sun_ros_msgs-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Trigger-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Trigger-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sun_ros_msgs-srv:<Trigger-request> is deprecated: use sun_ros_msgs-srv:Trigger-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Trigger-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Trigger-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sun_ros_msgs-srv:<Trigger-response> is deprecated: use sun_ros_msgs-srv:Trigger-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <Trigger-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sun_ros_msgs-srv:success-val is deprecated.  Use sun_ros_msgs-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <Trigger-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sun_ros_msgs-srv:message-val is deprecated.  Use sun_ros_msgs-srv:message instead.")
  (message m))
