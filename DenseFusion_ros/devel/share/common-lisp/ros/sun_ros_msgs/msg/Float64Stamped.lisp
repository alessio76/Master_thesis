...
(cl:defmethod cl:initialize-instance :after ((m <Float64Stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Float64Stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sun_ros_msgs-msg:<Float64Stamped> is deprecated: use sun_ros_msgs-msg:Float64Stamped instead.")))
