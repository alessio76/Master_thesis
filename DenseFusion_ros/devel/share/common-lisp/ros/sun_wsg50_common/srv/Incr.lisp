...
(cl:in-package sun_wsg50_common-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Incr-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Incr-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sun_wsg50_common-srv:<Incr-request> is deprecated: use sun_wsg50_common-srv:Incr-request instead.")))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <Incr-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sun_wsg50_common-srv:direction-val is deprecated.  Use sun_wsg50_common-srv:direction instead.")
  (direction m))

(cl:ensure-generic-function 'increment-val :lambda-list '(m))
(cl:defmethod increment-val ((m <Incr-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sun_wsg50_common-srv:increment-val is deprecated.  Use sun_wsg50_common-srv:increment instead.")
  (increment m))
...
(cl:defmethod cl:initialize-instance :after ((m <Incr-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Incr-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sun_wsg50_common-srv:<Incr-response> is deprecated: use sun_wsg50_common-srv:Incr-response instead.")))

(cl:ensure-generic-function 'error-val :lambda-list '(m))
(cl:defmethod error-val ((m <Incr-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sun_wsg50_common-srv:error-val is deprecated.  Use sun_wsg50_common-srv:error instead.")
  (error m))
