...
(cl:defmethod cl:initialize-instance :after ((m <Conf-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Conf-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sun_wsg50_common-srv:<Conf-request> is deprecated: use sun_wsg50_common-srv:Conf-request instead.")))

(cl:ensure-generic-function 'val-val :lambda-list '(m))
(cl:defmethod val-val ((m <Conf-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sun_wsg50_common-srv:val-val is deprecated.  Use sun_wsg50_common-srv:val instead.")
  (val m))
...
(cl:defmethod cl:initialize-instance :after ((m <Conf-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Conf-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sun_wsg50_common-srv:<Conf-response> is deprecated: use sun_wsg50_common-srv:Conf-response instead.")))
