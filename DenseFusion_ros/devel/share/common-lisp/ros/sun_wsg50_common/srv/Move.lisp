...
(cl:defmethod cl:initialize-instance :after ((m <Move-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Move-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sun_wsg50_common-srv:<Move-request> is deprecated: use sun_wsg50_common-srv:Move-request instead.")))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <Move-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sun_wsg50_common-srv:width-val is deprecated.  Use sun_wsg50_common-srv:width instead.")
  (width m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <Move-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sun_wsg50_common-srv:speed-val is deprecated.  Use sun_wsg50_common-srv:speed instead.")
  (speed m))
...
(cl:defmethod cl:initialize-instance :after ((m <Move-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Move-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sun_wsg50_common-srv:<Move-response> is deprecated: use sun_wsg50_common-srv:Move-response instead.")))
