...
"""autogenerated by genpy from pose_estimation/trajectoryActionGoal.msg. Do not edit."""
import codecs
import sys
...
class trajectoryActionGoal(genpy.Message):
  ...
  _type = "pose_estimation/trajectoryActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','pose_estimation/trajectoryGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = pose_estimation.msg.trajectoryGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = pose_estimation.msg.trajectoryGoal()
