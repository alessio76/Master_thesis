...
"""autogenerated by genpy from sun_robot_msgs/JointTrajectoryAction.msg. Do not edit."""
import codecs
import sys
...
class JointTrajectoryAction(genpy.Message):
  _md5sum = "752578ce55671f82a779ac36f67ce5cd"
  _type = "sun_robot_msgs/JointTrajectoryAction"
...
"""
  ...
  _slot_types = ['sun_robot_msgs/JointTrajectoryActionGoal','sun_robot_msgs/JointTrajectoryActionResult','sun_robot_msgs/JointTrajectoryActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = sun_robot_msgs.msg.JointTrajectoryActionGoal()
      if self.action_result is None:
        self.action_result = sun_robot_msgs.msg.JointTrajectoryActionResult()
      if self.action_feedback is None:
        self.action_feedback = sun_robot_msgs.msg.JointTrajectoryActionFeedback()
    else:
      self.action_goal = sun_robot_msgs.msg.JointTrajectoryActionGoal()
      self.action_result = sun_robot_msgs.msg.JointTrajectoryActionResult()
      self.action_feedback = sun_robot_msgs.msg.JointTrajectoryActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_dB().pack(_x.action_goal.goal.sampling_freq, _x.action_goal.goal.use_exponential_junction))
      length = len(self.action_goal.goal.initial_joints)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.action_goal.goal.initial_joints))
      _x = self
      buff.write(_get_struct_d3I().pack(_x.action_goal.goal.junction_time_constant, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.sampling_freq, _x.action_goal.goal.use_exponential_junction,) = _get_struct_dB().unpack(str[start:end])
      self.action_goal.goal.use_exponential_junction = bool(self.action_goal.goal.use_exponential_junction)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.initial_joints = s.unpack(str[start:end])
      _x = self
      start = end
      end += 20
      (_x.action_goal.goal.junction_time_constant, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.action_goal.goal.initial_joints.tostring())
      _x = self
      buff.write(_get_struct_d3I().pack(_x.action_goal.goal.junction_time_constant, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      _x = self.action_result.header.frame_id
      length = len(_x)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_goal.goal.initial_joints = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      _x = self
      start = end
      end += 20
      (_x.action_goal.goal.junction_time_constant, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_d3I().unpack(str[start:end])
