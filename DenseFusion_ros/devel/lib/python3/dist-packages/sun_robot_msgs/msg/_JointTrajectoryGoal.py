...
"""autogenerated by genpy from sun_robot_msgs/JointTrajectoryGoal.msg. Do not edit."""
import codecs
import sys
...
class JointTrajectoryGoal(genpy.Message):
  _md5sum = "1f432036db786cbab1e03854cd9964ae"
  _type = "sun_robot_msgs/JointTrajectoryGoal"
...
"""
  __slots__ = ['trajectory','sampling_freq','use_exponential_junction','initial_joints','junction_time_constant']
  _slot_types = ['trajectory_msgs/JointTrajectory','float64','bool','float64[]','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       trajectory,sampling_freq,use_exponential_junction,initial_joints,junction_time_constant
    ...
    if args or kwds:
      ...
      if self.use_exponential_junction is None:
        self.use_exponential_junction = False
      if self.initial_joints is None:
        self.initial_joints = []
      if self.junction_time_constant is None:
        self.junction_time_constant = 0.
    else:
      self.trajectory = trajectory_msgs.msg.JointTrajectory()
      self.sampling_freq = 0.
      self.use_exponential_junction = False
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_dB().pack(_x.sampling_freq, _x.use_exponential_junction))
      length = len(self.initial_joints)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.initial_joints))
      _x = self.junction_time_constant
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.sampling_freq, _x.use_exponential_junction,) = _get_struct_dB().unpack(str[start:end])
      self.use_exponential_junction = bool(self.use_exponential_junction)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.initial_joints = s.unpack(str[start:end])
      start = end
      end += 8
      (self.junction_time_constant,) = _get_struct_d().unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.initial_joints.tostring())
      _x = self.junction_time_constant
      buff.write(_get_struct_d().pack(_x))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.initial_joints = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 8
      (self.junction_time_constant,) = _get_struct_d().unpack(str[start:end])
      return self
