...
"""autogenerated by genpy from sun_robot_msgs/JointTrajectoryActionGoal.msg. Do not edit."""
import codecs
import sys
...
class JointTrajectoryActionGoal(genpy.Message):
  _md5sum = "551b1a32ce5bab12b30d7577269c3282"
  _type = "sun_robot_msgs/JointTrajectoryActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','sun_robot_msgs/JointTrajectoryGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = sun_robot_msgs.msg.JointTrajectoryGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = sun_robot_msgs.msg.JointTrajectoryGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_dB().pack(_x.goal.sampling_freq, _x.goal.use_exponential_junction))
      length = len(self.goal.initial_joints)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.goal.initial_joints))
      _x = self.goal.junction_time_constant
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.sampling_freq, _x.goal.use_exponential_junction,) = _get_struct_dB().unpack(str[start:end])
      self.goal.use_exponential_junction = bool(self.goal.use_exponential_junction)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.goal.initial_joints = s.unpack(str[start:end])
      start = end
      end += 8
      (self.goal.junction_time_constant,) = _get_struct_d().unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.goal.initial_joints.tostring())
      _x = self.goal.junction_time_constant
      buff.write(_get_struct_d().pack(_x))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.goal.initial_joints = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 8
      (self.goal.junction_time_constant,) = _get_struct_d().unpack(str[start:end])
      return self
