...
"""autogenerated by genpy from sun_robot_msgs/CartesianTrajectoryGoal.msg. Do not edit."""
import codecs
import sys
...
class CartesianTrajectoryGoal(genpy.Message):
  _md5sum = "e7fd141f55570565cc279335a6a6197c"
  _type = "sun_robot_msgs/CartesianTrajectoryGoal"
...
float64 y
float64 z"""
  __slots__ = ['trajectory','sampling_freq','use_trapez']
  _slot_types = ['sun_robot_msgs/CartesianTrajectory','float64','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       trajectory,sampling_freq,use_trapez
    ...
    """
    if args or kwds:
      super(CartesianTrajectoryGoal, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.trajectory is None:
        self.trajectory = sun_robot_msgs.msg.CartesianTrajectory()
      if self.sampling_freq is None:
        self.sampling_freq = 0.
      if self.use_trapez is None:
        self.use_trapez = False
    else:
      self.trajectory = sun_robot_msgs.msg.CartesianTrajectory()
      self.sampling_freq = 0.
      self.use_trapez = False
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_dB().pack(_x.sampling_freq, _x.use_trapez))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.sampling_freq, _x.use_trapez,) = _get_struct_dB().unpack(str[start:end])
      self.use_trapez = bool(self.use_trapez)
      return self
