...
def adding_mesh_object(
    ...
    if num ==0:
        ...
        toy_transform.set_rotation(
            visii.quat(random.uniform(0,1),random.uniform(0,1),random.uniform(0,1),random.uniform(0,1))
...
if opt.path_single_obj is not None:
    ...
    for i_obj in range(int(opt.nb_objects)):
        ...
        adding_mesh_object(name, obj_to_load, texture_to_load, model_info_path,num=i_obj, scale=opt.scale, debug=opt.debug)
